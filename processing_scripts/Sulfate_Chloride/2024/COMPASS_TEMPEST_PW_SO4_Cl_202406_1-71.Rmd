...
###### Run information - PLEASE CHANGE
  ...
  The 1st duplicate has high CV for both Cl and SO4, the 6th dup has high cv for cl only - check peaks 
  The 1st spk was low and was probably not spiked. 
...
raw_metadata_lys_combined <- raw_metadata_lys_combined %>%
  mutate(Cl_SO4_ID = ifelse(is.na(Event_Time), paste(Project,
                          Zone,
                          Grid,
                          Collection_Date, 
                          Depth, 
                          sep = "_"), 
                    ifelse(paste(Project,
                          Zone,
                          Grid,
                          Collection_Date, 
                          Depth, 
