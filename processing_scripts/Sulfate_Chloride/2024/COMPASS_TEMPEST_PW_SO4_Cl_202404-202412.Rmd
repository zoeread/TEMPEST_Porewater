...
###### Run information - PLEASE CHANGE
  ...
  run_notes = "Check standard 1 is low for SO4. 
  Some sample IDs are missing from metadata: TMP_SW_B4_20240426_15CM, TMP_SW_B4_20240711_15CM, TMP_SW_F6_20241111_15CM
...
#   ####Is there TEMPEST metadata?####
#   Raw_Metadata_Lys = "Raw Data/TEMPEST_PorewaterInventory_May2022_Present_Lysimeters.csv"
#   Raw_Metadata_SW = "Raw Data/TEMPEST_PorewaterInventory_May2022_Present_SourceWater.csv"
...
raw_metadata_lys_combined <- raw_metadata_lys_combined %>%
  select("Sample_ID", "Project", "Zone", "Source" ,"Grid", "Depth", "Analyte", "Collection_Date", "Event_Time", "Time_of_day", "Volume_mL")
...
all_data_flagged$sample_ID <- replace(all_data_flagged$sample_ID, all_data_flagged$sample_ID == "TMP_SW_RAINWATER_202412", "TMP_SW_RAINWATER_20241212")
all_data_flagged$sample_ID <- replace(all_data_flagged$sample_ID, all_data_flagged$sample_ID == "TMP_FW_RAINWATER_202412", "TMP_FW_RAINWATER_20241212")
all_data_flagged$sample_ID <- replace(all_data_flagged$sample_ID, all_data_flagged$sample_ID == "TMP_C_RAINWATER_202412", "TMP_C_RAINWATER_20241212")
...
df_all_clean <- merged_data %>%
  separate(
    col = sample_name,
    sep = "_",
    into = c("Sample_Number", "Project", "Zone", "Grid", "Collection_Date"),
    remove = FALSE)
