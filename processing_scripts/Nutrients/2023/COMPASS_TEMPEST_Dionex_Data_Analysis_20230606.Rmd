...
Sdat <- read.table("COMPASS_TEMPEST_20230606_SO4a.txt",sep='\t' , header=T, skip=3)
head(Sdat)
...
#Chloride data 
## Read in raw data file from Dionex - copied and saved as a txt
Cldat <- read.table("COMPASS_TEMPEST_20230606_Cla.txt",sep='\t' , header=T, skip=3)
head(Cldat)
...
write.csv(alldat, file="COMPASS_TEMPEST_Dionex_ClSo4_Final_20230606.csv")           #Change file name
