...
eems_all_meta_dups_merged <- eems_all_meta_no_reps %>% 
  ...
  select(-time.fill) %>%
  left_join(pooled_sample_key, by= c("Plot","Grid","date", "evacuation_date", "collection_date")) %>%
...
saveRDS(PW_eems_all, "~/GitHub/TEMPEST-1-porewater/processed data/TMP_PW_grids_CDOM_L1_TMP1TMP2.rds")
```
...
write_csv(l1_porewatergrids_2022, "~/GitHub/TEMPEST-1-porewater/processed data/TMP_PW_GRIDSandPOOL_CDOM_Indicies_L1_2022.csv")


l1_porewatergrids_2023 = PW_eems_allwpooled  %>%
   filter(collection_datetime < year2_stop & collection_datetime > year2_start)

write_csv(l1_porewatergrids_2023, "~/GitHub/TEMPEST-1-porewater/processed data/TMP_PW_GRIDSandPOOL_CDOM_Indicies_L1_2023.csv")
