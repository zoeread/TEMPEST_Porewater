...
stds <- read_plate(
  file = "TEMPEST_FE_20230609_Stds1.csv",             # full path to the .csv file
...
dat <- read_plate(
  file = ("TEMPEST_FE_20230609_Samples1.csv"), 
...
head(dat_IDs)
write.csv(dat_IDs, file="TEMPEST_FE_20230609_Summary_Data.csv")

#Read out all the data in dat 
head(dat)
write.csv(dat, file="TEMPEST_FE_20230609_Data.csv")
...
dat2 <- dat2[ ,-(2:9)]
head(dat2)
write.csv(dat2, file="TEMPEST_FE_20230609_short_Data.csv")
