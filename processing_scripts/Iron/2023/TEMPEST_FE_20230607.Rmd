...
stds <- read_plate(
  file = "TEMPEST_FE_20230607_Stds1.csv",             # full path to the .csv file
...
dat <- read_plates(
  files = c("TEMPEST_FE_20230607_Samples1.csv", 
            "TEMPEST_FE_20230607_Samples2.csv", "TEMPEST_FE_20230607_Samples3.csv"),   # full path to the .csv file
  plate_names = c("Samples1", "Samples2", "Samples3"),
  well_ids_column = "Wells",    # name to give column of well IDs (optional)
  sep = ","                     # separator used in the csv file (optional)
)
str(dat)
...
head(dat_IDs)
write.csv(dat_IDs, file="TEMPEST_FE_20230607_Summary_Data.csv")

#Read out all the data in dat 
head(dat)
write.csv(dat, file="TEMPEST_FE_20230607_Data.csv")
...
dat2 <- dat2[ ,-(2:9)]
head(dat2)
write.csv(dat2, file="TEMPEST_FE_20230607_short_Data.csv")
