...
stds <- read_plate(
  file = "TEMPEST_FE_20230606_Stds1.csv",             # full path to the .csv file
...
dat <- read_plate(
  file = "TEMPEST_FE_20230606_Samples1.csv",             # full path to the .csv file
  well_ids_column = "Wells",    # name to give column of well IDs (optional)
  sep = ","                     # separator used in the csv file (optional)
)
str(dat)
...
#spike for these samples was 55uL of the 500uM standard
QAspks$FE_2_spk_Conc <- (500*(55/1000000))                        # this would be in umoles of FE in the spk 
...
head(dat_IDs)
write.csv(dat_IDs, file="TEMPEST_FE_20230606_Summary_Data.csv")

#Read out all the data in dat 
head(dat)
write.csv(dat, file="TEMPEST_FE_20230606_Data.csv")
...
dat2 <- dat2[ ,-(2:9)]
head(dat2)
write.csv(dat2, file="TEMPEST_FE_20230606_short_Data.csv")
