...
directory= file.path(here() %>% dirname(), 'TEMPEST_Porewater/processing_scripts/DOC/tmp_doc_2024/tmp_doc_metadata_2024')
...
colnames(IDs) <- c("Site_Code" , "Date","Plot", "Grid_Square",  "Extra")
head(IDs)
