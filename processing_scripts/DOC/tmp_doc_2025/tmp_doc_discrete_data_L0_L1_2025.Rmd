...
folder_2025 <- "../tmp_doc_2025/tmp_doc_processed_data_2025/"
...
write_csv(clean_2025, paste0(folder_2025, "01_TMP_PW_NPOCTDN_2025_L1.csv") ) #note this is currently set up so that it writes into the folder youre pulling data from so if you run script more than once it will pull in the old file.
