...
# 7. write out
```{r write}
write_csv(l1_icp_pw_pooled_2022, "~/GitHub/TEMPEST-1-porewater/processed data/for_google_drive/TMP_PW_POOL_ICP_L1_2022.csv")

write_csv(l1_icp_source_2022, "~/GitHub/TEMPEST-1-porewater/processed data/for_google_drive/TMP_SOURCE_ICP_L1_2022.csv")


#For code review: 
write_csv(l1_icp_pw_pooled_2022, "~/GitHub/TEMPEST_Porewater/processing_scripts/ICP/TEMPORARY/TMP_PW_POOL_ICP_L1_2022.csv")

write_csv(l1_icp_source_2022, "~/GitHub/TEMPEST_Porewater/processing_scripts/ICP/TEMPORARY/TMP_SOURCE_ICP_L1_2022.csv")
